...
As announced by Apparyllis, Simply Plural servers will shut down on July 1, 2026. After that date, user data and avatars will be permanently deleted. The announcement says users can export their data and avatars through the app before that date.
