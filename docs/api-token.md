...
- Go to the [install and run guide](install-and-run.md) to set up your local environment.
- Read the [JSON export guide](json-export.md) to start preserving your data.
- Review the [privacy and safety notes](privacy-and-safety.md) to keep your data secure.
