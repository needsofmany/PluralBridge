...
public sealed class PrivacyBucketsController(
	IConfiguration configuration,
	ILogger<PrivacyBucketsController> logger) : ControllerBase
{
	/// <summary>
	...
	public async Task<IActionResult> Get(Guid systemId)
	{
		...
		try
		{
			...
			List<PrivacyBucket> privacyBuckets;

			try
			{
				privacyBuckets = await ReadPrivacyBucketsAsync(
					connection,
